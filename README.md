...
- download hbr_qtz.zip from [here](https://github.com/Pavel-Rychetsky/Hebrew-QWERTZ-Windows-keyboard/releases/latest) and unzip it
- run setup.exe from hbr_qtz directory
- the installed keyboard appears in system as "Hebrew - QWERTZ"
...
| y | ע ayin| ﬠ alternative ayin| # number sign|  |
